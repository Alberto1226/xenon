<script>
  ...
  function crear_el_pdf() {
    ...
    //    FEcha
    doc.fill("green", "even-odd").fontSize(7).text(`Fecha: ${fecha}  `, 400, y);
    ///    HORA
    y += +espacio_vertical_header;
    ...
    y += +espacio_vertical_header;
    doc.text("RFC CIX120105CTA  ", 0, y).fill("gray", "even-odd").fontSize(7);
  ...
  **La paquetería corre a cuenta y riesgo del cliente.`,
    ...
    **La paquetería corre a cuenta y riesgo del cliente.`,
    ...
    for (let index = 0; index < lista.length; index++) {
      ...
      doc.fill("gray", "even-odd").fontSize(7).restore();
      doc
      ...
      doc.fill("black", "even-odd").fontSize(7).restore();
