...
export async function post(req, res, next) {
   ...
   // console.log({producto_id,pagina_actual,periodicidad})
    ...
    const or_consulta = await crear_or(periodicidad,producto_id);
    //console.log("||||||||||||||||||||||||||||------------------")
...
function crear_or(periodicidad,id_producto) {

    try {
        let objectId = mongoose.Types.ObjectId;
        let consulta_or = {'lista.producto._id':objectId(id_producto)};
