...
export async function cambiar_categoria_producto({ producto_id, categoria_nueva }) {
    /*
        //  Checar permisos
    ...
    console.log("----->");
    console.log(lista_proceso_categorias);
    console.log("----->");
    //return { ok: true, lista_proceso_categorias }
    var lista = [];
    ...
    return proceso_cambiar_producto
