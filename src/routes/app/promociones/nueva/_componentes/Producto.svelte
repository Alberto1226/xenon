  ...
  <tr>
    ...
    <td>
      ...
      <Button
        ...
        raised
        ripple={false}
        style="padding-right: 4px;width:135%;font-size: 1.2em;height: 60px;">
...
close
 ...
 Productos
    ...
    <table style="width:80%;margin-bottom:20px;" class="colorblanco">
     ...
     <!-- antes de lista -->
      <div class="centrado">
      {#if $producto_selecto.nombre=="" || $producto_selecto.nombre=="ninguno"}
         <!-- content here -->
        <span class="colorblanco"> Pendiente </span>
      ...
      {:else}
         <!-- else content here -->
         <span class="colorblanco"> Producto <b>{producto.nombre}</b> seleccionado</span>
