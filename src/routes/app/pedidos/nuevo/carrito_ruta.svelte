<script>
    ...
    import Row_productos from "../editar/Row_producto.svelte";
    ...
    */
    ...
    function filtrar_nuevo_arreglo() {
        console.log("filtrando nuevo arreglo");
        if (buscar == "") {
            lista = $productos.lista;
            return;
        }
                ...
                .then((respuesta) => {
                    ...
                    if (respuesta.ok) {
                        ...
                        let pedido_en_lista = lista_temp.find(
                            (element) =>
                                element._id === $editar_store.pedido._id,
                        );
                        pedido_en_lista = respuesta.carrito;
                        // $lista_productos_en_pedido_en_edicion =
                        //     respuesta.carrito.lista;
                        //$pedidos.lista = lista_temp;
...
<div class="grid-container">
            ...
            <table style="margin: -23px 0 0 39px;">
                <tr>
                    ...
                    <td>
                        ...
                        <span title="total de páginas"
                            >de {$productos.paginas}</span
                        >
                    </td>
                    ...
                    <td>
                        ...
                        {:else}
                            <span class="indice_row"
                                >total {$productos.total_registros}</span
                            >
                        {/if}
                    </td>
                </tr>
                    ...
                    {#each $productos.lista as producto, i (producto._id)}
                        ...
                        {:else}
                            ...
                            <Row_productos
                                ...
                                {producto}
                                indice={10 * $productos.pagina_actual +
                                    i +
                                    1 -
                                    10}
                            />
            ...
            <table class="cantidad">
                <tr>
                    {#if tenia_ficha == false}
                        ...
                        <td>
                            Total Unidades:
                            <b style="font-weight:800;font-size:1.2em"
                                >{total_unidades}</b
                            >
                        </td>
                    {:else}
    ...
    <div class="barra_1">
        ...
        <div style="padding-top: 10px;">
            {$editar_store.pedido.cliente.correo}
        </div>
