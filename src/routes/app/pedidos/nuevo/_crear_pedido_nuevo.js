        ...
        .then((async (contador_suficientes) => {
            ...
            if (proceso_apartado.insuficientes > 0) {
                ...
                borrar_ficha_si_existe(
                    ...
                    ///     Crear Carrito 
                    crear_su_carrito(data, email, borrado_ficha.tenia_ficha, req.user).then((carrito_creado) => {
...
function apartar_productos(data) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let lista_productos = data.lista_productos_en_pedido_nuevo;
    ...
    return new Promise((resolve, reject) => {
        Producto.findById(id_producto)
            .then((documento) => {
                ...
                let hay_suficientes = suficientes_productos(documento.existencia.actual, documento.carritos, cantidad_necesaria);
...
function suficientes_productos(
    ...
    let suficientes = ((+existencias - +total_reservado) >= 0);
...
function crear_su_carrito(data, email, tenia_ficha, usuario) {
    return new Promise(async (resolve, reject) => {
        ...
        //console.log("data.pedido_nuevo.cliente_email"+data.pedido_nuevo.cliente_correo);
        // //console.log(data.pedido_nuevo);
        //console.log(data);
        ...
        //console.log("total =" + total_pedido);
        //console.log(total_pedido);
        //console.log(data.pedido_nuevo.agente);
