...
export async function post(req, res, next) {
    ...
    let producto_borrado= doc_post.producto_borrado;
    ...
    .then((carrito_DB)=>{
        ...
        const producto_a_cambiar = lista_nueva.find(elem=> elem.producto._id ==producto_borrado._id )
        producto_a_cambiar.fue_anulado_del_pedido = true;
