<script>
  ...
  var tipo_de_cambio;
  onMount(() => {
    notas = pedido_selecto.notas
      ? pedido_selecto.notas
      : $editar_store.pedido.notas;
    //console.log('notas='+notas);
    tipo_de_cambio = pedido_selecto.tipo_de_cambio
      ? pedido_selecto.tipo_de_cambio
      : $editar_store.pedido.tipo_de_cambio;
...
<div class="grid-container">
  <div class="cliente">
    ...
    <div class="padding">
      ...
      {direccion == ""
        ? "--"
        : "Perfil de cliente: " + cliente.perfil.perfil + " "}
      <b>{formato_precio(cliente.perfil.porcentaje)}</b>
      <br />
      {$editar_store.pedido.agente.nombre == "" ? "--" : " Agente: "}
      <b>{cliente.agente}</b>
      <br />
      {#if obs == ""}
        {obtener_cliente()}
      ...
      <p class="observaciones">
        {obs == "" ? "Sin Observaciones" : "Observaciones: "} <b>{obs}</b>
      </p>
        ...
        <Button
          ...
          on:click={() => {
            ...
            if (
              ...
              tipo_de_cambio_original != pedido_selecto.tipo_de_cambio ||
              notas != $editar_store.pedido.notas
            )
              actualizar_moneda_y_direccion_y_continuar(
