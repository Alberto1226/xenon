...
<div class="grid-container row">
  ...
  <div class="cinco">
    ...
    {/if}
    {formato_precio(pedido.descuento)} %
    <span title="Moneda nacional">$ {formato_precio(pedido.total_pedido)}</span>
    <br />
  ...
  <div class="ocho centrado" class:status_cambiado={status_cambiando}>
    {#if pedido.mensajeria}
      <!-- content here -->
      {pedido.mensajeria.empresa}
      <br />
      <div class="codigo pointer" title={pedido.mensajeria.codigo_de_rastreo}>
        {pedido.mensajeria.codigo_de_rastreo}
      </div>
      <div class="notas pointer" title={pedido.mensajeria.notas}>
        {pedido.mensajeria.notas}
      </div>
    {:else}
      <span class="indice_row">-No se registro mensajería-</span>
    {/if}
  </div>
  <div class="nueve">
    <table>
      <tr>
        <td>
          <ButtonGroup>
            ...
            <div class="notas_internas pointer" title={pedido.notas}>
              {pedido.notas !== "" ? "Notas (Xenon):" : ""}
              {pedido.notas}
            </div>
